...
public interface ISpecialInventory extends IInventory {
	 ...
	 * 
	 * @param doRemove
	 *            If false no actual extraction may occur. Implementors should
	 *            simulate. Can be used to "peek" at what the result would be
	 * @param from
	 *            Orientation the ItemStack is requested from.
	 * @param maxItemCount
	 *            Maximum amount of items to extract (spread over all returned
	 *            item stacks)
	 * @return Array of item stacks that were/would be extracted from the
	 *         inventory
	 */
